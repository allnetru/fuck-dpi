...
echo -e "${CYAN}╚══════════════════════════════════════════════════════════════╝${NC}"
echo ""
echo -e "  Голый WireGuard палится DPI по сигнатуре — exit-IP со временем"
echo -e "  могут точечно заблокировать. Чтобы спрятать WG в TLS (HTTPS):"
echo -e "    ${YELLOW}sudo ./setup-obfuscation.sh foreign${NC}   (нужен домен на этот VPS)"
echo -e "  затем на российском VPS — ${YELLOW}sudo ./setup-obfuscation.sh ru${NC}"
echo ""
